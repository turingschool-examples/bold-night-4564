...
ActiveRecord::Schema.define(version: 2021_07_26_174211) do
  ...
  create_table "amusement_parks", force: :cascade do |t|
    ...
    t.bigint "ride_id"
    t.index ["amusement_park_id"], name: "index_amusement_parks_on_amusement_park_id"
  ...
  add_foreign_key "amusement_parks", "amusement_parks"
